  ...
  return (
    <div className="flex h-full w-64 flex-col items-center gap-y-20 bg-zinc-700">
      ...
      <div className="flex w-full flex-col gap-y-2 px-8">
        <div className="flex h-14 w-full items-center gap-x-6">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
          ...
          <div className="tracking-tight text-indigo-100">Overview</div>
        </div>
        <Link href={"/users"} className="flex h-14 w-full items-center gap-x-6">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
          ...
          <div className="tracking-tight text-gray-400">Users</div>
        </Link>
      </div>
    </div>
  );
